  ...
  <div class="header-contacts">
    <div class="header-contacts__body container">
      <a href="/" class="header-contacts__logo">
        <img src="./../src/img/Logo.svg" width="210" height="36" alt="">
      </a>
      <ul class="header-contacts__list">
        <li class="header-contacts__item">
          <div class="header-contacts__icon icon">
            <!-- {{> icons/icon-clock-yellow }} -->
          </div>
        ...
        <li class="header-contacts__item">
          ...
          <div class="header-contacts__info">
            <a href="mailto:contact@logistics.com" class="header-contacts__link" target="_blank">
              Email<br>
        ...
        <li class="header-contacts__item">
          ...
          <div class="header-contacts__info">
            <a href="tel:+00112365489" class="header-contacts__link" target="_blank">
              Call Us<br>
              (00) 112 365 489
            </a>
          </div>
      ...
      <div class="header-nav">
        <ul class="header-nav__list">
          ...
          <li class="header-nav__item header-nav__item--dropdown">
            <button class="header-nav__button header-nav__button--dropdown">Pages</button>
          ...
          <li class="header-nav__item">
            <a href="/project.html" class="header-nav__link">Project</a>
          </li>
          <li class="header-nav__item">
      ...
      <div class="header-socials">
        <ul class="header-socials__list">
          <li class="header-socials__item">
            <a href="https://instagram.com" class="header-socials__link" target="_blank">
              <!-- Instagram SVG icon -->
          ...
          <li class="header-socials__item">
            <a href="https://facebook.com" class="header-socials__link" target="_blank">
              <!-- Facebook SVG icon -->
          ...
          <li class="header-socials__item">
            <a href="https://x.com" class="header-socials__link" target="_blank">
              <!-- X (Twitter) SVG icon -->
          ...
          <li class="header-socials__item">
            <a href="https://linkedin.com" class="header-socials__link" target="_blank">
              <!-- LinkedIn SVG icon -->
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <button class="header-socials__btn" type="button"><a href="/">Request Quote</a></button>
      </div>
    </div>
  </div>
