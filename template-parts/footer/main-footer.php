      ...
      <div class="footer-right__wrapper">
        ...
        <div class="footer-right__content">
          <ul class="footer-right__list">
            <li class="footer-right__item">About Us</li>
            <li class="footer-right__item">Our Team</li>
            <li class="footer-right__item">Our Project</li>
            <li class="footer-right__item">Pricing</li>
            <li class="footer-right__item">Contact</li>
          </ul>
        </div>
      </div>
      <div class="footer-right__wrapper">
        ...
        <div class="footer-right__content">
          <ul class="footer-right__list">
            <li class="footer-right__item">Style Guide</li>
            <li class="footer-right__item">Changelog</li>
            <li class="footer-right__item">Licenses</li>
            <li class="footer-right__item">Protected</li>
            <li class="footer-right__item">Not Found</li>
          </ul>
        </div>
      </div>
      <div class="footer-right__wrapper">
        ...
        <div class="footer-right__content">
          <form action="/" class="footer-right__form">
            <label for="email" class="footer-right__label"></label>
            <input type="email" id="email" class="footer-right__control" placeholder="Email here*" required>
          </form>
